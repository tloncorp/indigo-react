  ...
  <React.Fragment>
    ...
    <Box fontFamily="mono">
      <Flex mb={[5]} alignItems="baseline" >
        ...
        <Box width={3/12} bg="lightGray" p={[2]} borderRadius="0" fontFamily="sans">No Border Radius
        </Box>
      </Flex>
      <Flex mb={[5]} alignItems="baseline" >
        <Box width={6/12}>borderRadius.1</Box>
        <Box width={3/12}>1</Box>
        <Box width={3/12} bg="lightGray" p={[2]} borderRadius="1" fontFamily="sans">Border Radius
        </Box>
      </Flex>
    </Box>
  </React.Fragment>
