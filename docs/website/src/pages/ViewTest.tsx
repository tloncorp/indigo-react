...
const Sourcelist = ({listItems}) => {
  return (
    <Col display='relative'>
      <Row height='8' top='0' position='sticky' backgroundColor='white' borderBottom='1px solid silver' borderBottomColor='gray' px='4' alignItems='center'>
        <Text>Title</Text>
      </Row>
      {
        listItems.map(item =>
          <Row height='96px' p='4' borderBottom='1px solid silver' borderBottomColor='gray'>
            <Text>{item}</Text>
          </Row>
        )
      }
    ...
    return (
      ...
      >
        <View
          ...
          <Row borderBottom='1px solid silver' borderBottomColor='gray' height='8' width='100%' px='4' alignItems='center'>
            <IconButton
              sm
